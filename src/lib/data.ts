...
export const products: Product[] = [
  ...
  },
  {
    ...
    description: 'Lightweight, packable hammock made from ripstop nylon with carabiners and straps included. Perfect for camping, hiking, or backyard relaxation.',
    price: 69.99,
    images: [
      'https://images.unsplash.com/photo-1504851149312-7a075b496cc7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80',
    ],
    category: 'Outdoor',
    featured: false,
    inStock: true,
  ...
  },
  {
    ...
    description: 'Double-walled vacuum insulated stainless steel water bottle that keeps drinks cold for 24 hours or hot for 12 hours.',
    price: 34.99,
    images: [
  ...
  },
  {
    ...
    description: 'Steel fire pit with mesh spark screen, log grate, and poker. The perfect centerpiece for outdoor gatherings in any season.',
    price: 149.99,
    images: [
      'https://images.unsplash.com/photo-1578690039701-8781f93db7af?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80',
    ],
    category: 'Outdoor',
    featured: false,
    inStock: true,
  ...
  },
  {
    ...
    price: 199.99,
    images: [
      'https://images.unsplash.com/photo-1575311373937-040b8e1fd962?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80',
    ],
    category: 'Wellness',
    featured: true,
    inStock: true,
  ...
  },
  {
    id: '43',
    name: 'Yoga Mat',
    description: 'Premium eco-friendly yoga mat with alignment markings. Non-slip surface, excellent cushioning, and carrying strap included.',
    price: 79.99,
    images: [
  ...
  },
  {
    ...
    description: 'Ultrasonic essential oil diffuser with 7 LED light options, auto shut-off, and multiple mist settings for aromatherapy benefits.',
    price: 49.99,
    images: [
  ...
  },
  {
    ...
    description: 'Automatic moving toy that keeps pets entertained and active. Features unpredictable movements and adjustable speed settings.',
    price: 29.99,
    images: [
  ...
  },
  {
    id: '46',
    name: 'Pet Camera',
    description: 'Wi-Fi-connected pet camera with two-way audio, treat dispenser, and night vision. Monitor and interact with your pets when away from home.',
    price: 169.99,
    images: [
  ...
  },
  {
    ...
    description: 'Memory foam pet bed with removable, washable cover. Provides joint support and comfort for pets of all ages.',
    price: 89.99,
    images: [
      'https://images.unsplash.com/photo-1541781774459-bb2af2f05b55?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80',
    ],
    category: 'Pets',
    featured: false,
    inStock: true,
  ...
  },
  {
    id: '48',
    name: 'E-Reader',
    description: 'Waterproof e-reader with adjustable warm light, weeks of battery life, and storage for thousands of books. Perfect for reading anywhere.',
    price: 149.99,
    images: [
  ...
  },
  {
    ...
    description: 'Bamboo book stand with adjustable angles and page holders. Ideal for cookbooks, textbooks, tablets, and more.',
    price: 39.99,
    images: [
  ...
  },
  {
    ...
    description: 'Handcrafted fountain pen with smooth ink flow, balanced weight, and elegant design. Comes with a premium gift box and ink cartridges.',
    price: 79.99,
    images: [
